<?php
$pageTitle = 'Gojacdoors - Terms & Conditions';
$activePage = '';
?>
<!DOCTYPE html>
    ...
    <main class="grow container mx-auto px-4 md:px-8 py-12 max-w-4xl">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl p-8 md:p-12 shadow-modern dark:shadow-modern-dark border border-slate-100 dark:border-slate-800"
            ...
            <div class="prose dark:prose-invert max-w-none space-y-6 text-slate-600 dark:text-slate-400">
                <p>
                    Welcome to Gojacdoors. By accessing or using our website and purchasing our products, you agree to
                    comply
                ...
                <p>
                    ...
                    downloads, and data compilations, is the property of Gojacdoors or its content suppliers and
                    protected by
                ...
                <p>
                    Gojacdoors shall not be liable for any special or consequential damages that result from the use of,
                    or
