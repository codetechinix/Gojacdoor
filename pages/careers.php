...
<body
    ...
    <main class="grow container mx-auto px-4 md:px-8 py-12 max-w-4xl">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-2xl p-8 md:p-12 shadow-modern dark:shadow-modern-dark border border-slate-100 dark:border-slate-800"
            data-aos="fade-up">
            <h1 class="text-4xl font-bold mb-4 font-display">Careers at Gojacdoors</h1>
            ...
            <div class="prose dark:prose-invert max-w-none space-y-6 text-slate-600 dark:text-slate-400">
                <p>
                    ...
                    and exceptional customer experiences. At Gojacdoors, you'll find a collaborative, fast-paced
                    environment
                ...
                <ul class="list-disc pl-5 space-y-2">
                    ...
                    <li>Generous employee discount on all Gojacdoors apparel.</li>
                ...
                <div
                    ...
                    <a href="mailto:careers@gojacdoors.example.com"
                        class="text-primary font-bold hover:underline">careers@gojacdoors.example.com</a>
                </div>
            </div>
            ...
            <div
                ...
                <p class="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-widest">Share this page
                </p>
