...
<body
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center py-20">
        ...
        <!-- Social Links Footer -->
        <div class="mt-16 flex flex-wrap items-center justify-center gap-6 color-slate-500">
            <a href="#" data-share="whatsapp" class="hover:text-white transition-all duration-300"
            ...
            <a href="#" data-share="x" class="hover:text-white transition-all duration-300" aria-label="Share on X">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path
                        d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
            </a>
            <a href="#" data-share="facebook" class="hover:text-white transition-all duration-300"
            ...
            <a href="#" data-share="instagram" class="hover:text-white transition-all duration-300"
            ...
            <a href="#" data-share="tiktok" class="hover:text-white transition-all duration-300"
            ...
            <a href="#" data-share="copy" class="hover:text-white transition-all duration-300" aria-label="Copy Link">
