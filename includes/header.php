...
<header id="mainHeader"
    ...
    <div class="container mx-auto px-4 md:px-12 flex items-center justify-between h-[90px]">
        ...
        <div class="flex-1 md:w-1/4 shrink-0 flex items-center justify-center md:justify-start">
        ...
        <nav class="hidden md:flex flex-1 justify-center space-x-8 shrink-0">
            ...
            <div class="group relative flex items-center">
                ...
                <div id="desktop-search"
                    class="absolute top-full right-0 mt-4 w-[400px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-2xl rounded-2xl hidden z-100 transform origin-top-right transition-all duration-300">
        ...
        <div class="w-1/4 md:flex-1 md:w-1/4 flex items-center justify-end space-x-6 shrink-0 relative">
            ...
            <a href="https://wa.me/1234567890" target="_blank"
                class="group bg-green-50 border border-green-200 hover:bg-green-500 hover:border-green-500 dark:bg-green-900/20 dark:border-green-800 dark:hover:bg-green-600 text-green-700 hover:text-white dark:text-green-400 dark:hover:text-white px-7 py-2.5 rounded-full font-bold uppercase tracking-widest text-[13px] transition-all duration-300 hidden lg:flex items-center space-x-2 shadow-sm">
    ...
    <div id="searchOverlay"
        class="fixed inset-0 w-full h-full bg-white/95 dark:bg-slate-950/95 backdrop-blur-3xl transition-all duration-500 opacity-0 scale-95 invisible z-100"
...
<div id="mobileMenu"
    class="fixed top-0 left-0 w-[85%] max-w-[340px] h-full bg-white dark:bg-slate-900 z-110 transform -translate-x-full transition-transform duration-300 ease-in-out md:hidden flex flex-col shadow-2xl">
    <div
    ...
    <div class="p-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/20 mt-auto shrink-0">
        <a href="https://wa.me/1234567890" target="_blank"
            class="flex items-center justify-center w-full bg-primary border-2 border-transparent text-white hover:bg-slate-900 dark:hover:bg-white dark:hover:text-slate-900 dark:focus:ring-white focus:ring-slate-900 py-3 rounded-full font-bold tracking-widest uppercase text-sm transition-all duration-300 mb-4 shadow-md">
